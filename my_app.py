...
def update_chart(selected_county):
    ...
    fig.update_layout(
        ...
        yaxis=dict(title='Students Affected', range=[0, max_students_affected], showgrid=False),
        yaxis2=dict(title='Instructional Days Lost per Student', range=[0, 21], showgrid=False),
